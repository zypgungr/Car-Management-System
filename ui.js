...
UI.prototype.addCarToUI = function (newCar) {
    ...
    carList.innerHTML += `
    <tr>
        <td><img src="${newCar.url}" class="img-fluid img-thumbnail" style="width:100px"></td>
        <td>${newCar.title}</td>
        <td>${newCar.price}</td>
        <td><a href="#" id = "delete-car" class = "btn btn-danger">Delete Car</a></td>
    </tr> 
`
}
...
UI.prototype.loadAllCars = function (cars) {
    ...
    cars.forEach(function (car) {
        carList.innerHTML += `
        <tr>
            <td><img src="${car.url}" class="img-fluid img-thumbnail" style="width:100px"></td>
            <td>${car.title}</td>
            <td>${car.price}</td>
            <td><a href="#" id = "delete-car" class = "btn btn-danger">Delete Car</a></td>
        </tr> 
